    ...
    <div className={cn("relative", className)} {...props}>
      ...
      >
        {items.map((item, index) => (
          <button
            key={index}
            className="w-8 h-8 px-3 py-1 rounded-full flex justify-center items-center gap-2 hover:bg-white/10 transition-colors"
          ...
          >
            <div className="flex justify-center items-center">
              <div className="w-[18px] h-[18px] flex justify-center items-center overflow-hidden">
                <item.icon className="w-full h-full text-[#bab5ae]" />
              </div>
            </div>
