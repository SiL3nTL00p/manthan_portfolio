            ...
            <main className="flex flex-col items-center justify-start bg-[#111111] text-white font-sfmono relative z-10 pt-4 animate-in fade-in duration-1000">
                ...
                <div className="w-full grid grid-cols-2 md:grid-cols-12 gap-y-8 md:gap-x-4 md:gap-y-0 items-start px-5">
                    ...
                    <section className="col-span-2 md:col-span-5 space-y-3 animate-in fade-in duration-1000" style={{ animationDelay: '200ms' }}>
                        ...
                        <h2 className="text-[#7a7770] text-[14px] md:text-[15px] font-sfmono tracking-[0.1em] uppercase select-none mb-3" style={{ fontWeight: 400 }}>
                            About
                        </h2>
                    ...
                    {/* COLUMN 8-10: Experience Section */}
                    <section className="col-span-2 md:col-span-3 space-y-3 animate-in fade-in duration-1000" style={{ animationDelay: '300ms' }}>
                        <h2 className="text-[#7a7770] text-[14px] md:text-[15px] font-sfmono tracking-[0.15em] uppercase mb-3 select-none" style={{ fontWeight: 400 }}>My Experience</h2>
                        <ul className="space-y-2 list-disc text-[14.1px] md:text-[15px] leading-tight list-inside text-[#ffffff]" style={{ fontFamily: '"Neue Haas Unica", "IBM Plex Sans", ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans"', fontWeight: 500 }}>
                    ...
                    {/* COLUMN 11: Connect Section */}
                    <section className="col-span-1 md:col-span-1 space-y-3 animate-in fade-in duration-1000" style={{ animationDelay: '400ms' }}>
                        <h2 className="text-[#7a7770] text-[14.1px] md:text-[15px] font-sfmono tracking-[0.15em] uppercase mb-3 select-none" style={{ fontWeight: 400 }}>
                            Connect
                        </h2>
                    ...
                    <section className="col-span-1 md:col-span-2 md:col-start-11 space-y-3 animate-in fade-in duration-1000" style={{ animationDelay: '500ms' }}>
                        <h2 className="text-[#7a7770] text-[14px] md:text-[15px] font-sfmono tracking-[0.15em] uppercase mb-3 select-none" style={{ fontWeight: 400 }}>
                            Links
                        </h2>
