...
function ListItem({ href, text }: { href: string; text: string }) {
    return (
        <li className="group">
            ...
            >
                <span className="text-sm font-semibold text-[#ffffff] border-b border-dotted border-[#444] leading-tight  hover:text-[#ef6e3b] transition-all duration-300 ease-in-out font-inter">
                    {text}
                </span>
            ...
            <main className="flex items-center justify-center bg-[#0b0909] text-white font-sfmono relative z-10 pt-4">
                ...
                <div className="w-full grid grid-cols-2 md:grid-cols-[1.1fr_1.1fr_1.1fr_1.1fr_0.9fr_0.9fr] gap-6 items-start px-5">
                    ...
                    <section className="col-span-2 space-y-3">
                        ...
                        {/* Bio Text */}
                        <div className="space-y-4 text-sm leading-tight  font-inter font-semibold text-[#ffffff]">
                    ...
                    <section className="col-span-2 space-y-3 md:ml-4">
                        <h2 className="text-[#7a7770] text-xs font-sfmono tracking-[0.15em] uppercase mb-3 select-none font-normal">My Experience</h2>
                    ...
                    <section className="space-y-3 md:pl-2">
                        <h2 className="text-[#7a7770] text-xs font-sfmono tracking-[0.15em] uppercase mb-3 select-none font-normal">
                            Connect
                        </h2>
