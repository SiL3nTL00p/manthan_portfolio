...
function ListItem({ href, text }: { href: string; text: string }) {
    return (
        <li className="group">
            ...
            >
                <span className="text-sm font-semibold text-[#ffffff] border-b border-dotted border-[#444] leading-tight tracking-tight hover:text-[#ef6e3b] transition-all duration-300 ease-in-out font-inter">
                    {text}
                </span>
